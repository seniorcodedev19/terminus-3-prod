...
Consider if the feedback is valid
...
Document your position clearly in the submission
Reach out on Slack to #terminus-3-submissions;
...
How to Appeal
Reply to the decision with your reasoning
Provide specific evidence for your position
Be professional - appeals are reviewed by seniors
Accept the outcome - final decisions are final
Appeal Template
